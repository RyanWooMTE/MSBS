function predictedusage = analysis_debug(datafile,polydegree,predictdate)
...
hold on
datesFit = dates(1) + years(elapsedYears);
plot(datsFit,usageFit,'Color',[0.75 0 0],'LineWidth',2)
hold off
xlabel('Date')
