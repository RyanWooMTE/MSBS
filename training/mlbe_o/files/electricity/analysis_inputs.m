function predictedusage = analysis_inputs(datafile,polydegree,predictdate,monthavg,nummonthmodel,makeplot)
...
% monthavg - the number of months to use in moving average [scalar]
...
for k = 1:length(sectors)
    ...
    % Do polynomial fit
    c = polyfit(elapsedYears,usageAvg(modelidx),polydegree);
