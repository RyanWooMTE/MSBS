/*
 *   LGMode_lct_sfcn.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        double y1 = LGMode_lct(uint8 u1, uint8 u2)
 *
 *   Simulink version           : 8.5 (R2015a) 09-Feb-2015
 *   C source code generated on : 19-Mar-2015 18:21:21
 ...
 */
#define S_FUNCTION_NAME                LGMode_lct_sfcn
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "LandingGearMode_initialize", MDL_INFO_ID_RESERVED, 0, 0,
                 ssGetPath(S));

    /*
     * Register reserved identifier for OutputFcnSpec
     */
    ssRegMdlInfo(S, "LGMode_lct", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
