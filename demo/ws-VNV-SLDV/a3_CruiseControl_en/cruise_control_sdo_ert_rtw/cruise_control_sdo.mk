...
MODEL                   = cruise_control_sdo
MODULES                 = 
MAKEFILE                = cruise_control_sdo.mk
...
MASTER_ANCHOR_DIR       = 
START_DIR               = C:\Mathworks\Workspace\Demo\Workshop_SLDV\a3_CruiseControl_en
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
BUILDARGS               =  GENERATE_REPORT=1PORTABLE_WORDSIZES=0 GENERATE_ASAP2=0
MULTITASKING            = 0
INTEGER_CODE            = 1
MAT_FILE                = 0
ONESTEPFCN              = 1
...
GEN_SAMPLE_MAIN         = 1
TARGET_LANG_EXT         = c
MEX_OPT_FILE            = -f C:\Users\hualongy\AppData\Roaming\MATHWO~1\MATLAB\R2012b\mexopts.bat
COMPUTER                = PCWIN64
...
MODELLIB                  = cruise_control_sdolib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = cruise_control_sdo_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\cruise_control_sdo_ert_rtw
