function rule = sldvrule_CompareToConstant
...
%% 置換用ライブラリ
rule.replacementPath = sprintf('sldvdemolib_boundarytest/CTC');  
...
parameter.const= '$original.const$';
...
% 置換を行う場合は true を出力
if strcmp(get_param(blockH,'MaskType'),'Compare To Constant')
    out = true;
else
    out = false;
end
