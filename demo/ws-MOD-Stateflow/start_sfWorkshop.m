function start_sfWorkshop(varargin)
...
%open([pwd '\html\Introduction to Stateflow.html']);
open(fullfile(pwd,'html','Introduction to Stateflow.html'));

% Suppress warning about loading
