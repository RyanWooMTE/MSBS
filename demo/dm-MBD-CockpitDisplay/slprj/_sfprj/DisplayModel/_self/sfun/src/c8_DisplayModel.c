...
static void initialize_c8_DisplayModel(SFc8_DisplayModelInstanceStruct
  *chartInstance);
static void initialize_params_c8_DisplayModel(SFc8_DisplayModelInstanceStruct
  *chartInstance);
static void enable_c8_DisplayModel(SFc8_DisplayModelInstanceStruct
  *chartInstance);
static void disable_c8_DisplayModel(SFc8_DisplayModelInstanceStruct
  *chartInstance);
static void c8_update_debugger_state_c8_DisplayModel
  (SFc8_DisplayModelInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_DisplayModel
  (SFc8_DisplayModelInstanceStruct *chartInstance);
static void set_sim_state_c8_DisplayModel(SFc8_DisplayModelInstanceStruct
  *chartInstance, const mxArray *c8_st);
static void c8_set_sim_state_side_effects_c8_DisplayModel
  (SFc8_DisplayModelInstanceStruct *chartInstance);
static void finalize_c8_DisplayModel(SFc8_DisplayModelInstanceStruct
  *chartInstance);
static void sf_c8_DisplayModel(SFc8_DisplayModelInstanceStruct *chartInstance);
static void initSimStructsc8_DisplayModel(SFc8_DisplayModelInstanceStruct
  *chartInstance);
static void c8_enter_internal_Screen(SFc8_DisplayModelInstanceStruct
  *chartInstance);
static void c8_enter_internal_three(SFc8_DisplayModelInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static real_T c8_emlrt_marshallIn(SFc8_DisplayModelInstanceStruct *chartInstance,
  const mxArray *c8_num, const char_T *c8_identifier);
static real_T c8_b_emlrt_marshallIn(SFc8_DisplayModelInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static boolean_T c8_c_emlrt_marshallIn(SFc8_DisplayModelInstanceStruct
  *chartInstance, const mxArray *c8_aVarTruthTableCondition_3, const char_T
  *c8_identifier);
static boolean_T c8_d_emlrt_marshallIn(SFc8_DisplayModelInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
...
static real_T c8_valid_sensors(SFc8_DisplayModelInstanceStruct *chartInstance);
static void c8_none(SFc8_DisplayModelInstanceStruct *chartInstance);
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_e_emlrt_marshallIn(SFc8_DisplayModelInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static uint8_T c8_f_emlrt_marshallIn(SFc8_DisplayModelInstanceStruct
  *chartInstance, const mxArray *c8_b_tp_Screen, const char_T *c8_identifier);
static uint8_T c8_g_emlrt_marshallIn(SFc8_DisplayModelInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
...
static const mxArray *c8_g_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_h_emlrt_marshallIn(SFc8_DisplayModelInstanceStruct *chartInstance,
  const mxArray *c8_b_select, const char_T *c8_identifier, real_T c8_y[2]);
static void c8_i_emlrt_marshallIn(SFc8_DisplayModelInstanceStruct *chartInstance,
...
static void c8_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_j_emlrt_marshallIn(SFc8_DisplayModelInstanceStruct
  *chartInstance, const mxArray *c8_b_setSimStateSideEffectsInfo, const char_T
  *c8_identifier);
static const mxArray *c8_k_emlrt_marshallIn(SFc8_DisplayModelInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_updateDataWrittenToVector(SFc8_DisplayModelInstanceStruct
  *chartInstance, uint32_T c8_vectorIndex);
static void c8_errorIfDataNotWrittenToFcn(SFc8_DisplayModelInstanceStruct
  *chartInstance, uint32_T c8_vectorIndex, uint32_T c8_dataNumber);
static void init_dsm_address_info(SFc8_DisplayModelInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_DisplayModel = 0U;
  chartInstance->c8_is_c8_DisplayModel = c8_IN_NO_ACTIVE_CHILD;
  ...
  (SFc8_DisplayModelInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c8_is_active_c8_DisplayModel == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 2U, chartInstance->c8_sfEvent);
  }

  if (chartInstance->c8_is_c8_DisplayModel == c8_IN_Screen) {
  ...
  (SFc8_DisplayModelInstanceStruct *chartInstance)
{
  ...
  boolean_T *c8_valid_signal;
  c8_valid_signal = (boolean_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c8_st = NULL;
  c8_st = NULL;
  c8_y = NULL;
  ...
  *chartInstance, const mxArray *c8_st)
{
  ...
  *c8_valid_signal = c8_c_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c8_prev_signal = c8_c_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c8_u, 7)), "prev_signal");
  c8_h_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 8)),
                        "select", c8_dv0);
  ...
  chartInstance->c8_is_active_c8_DisplayModel = c8_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 10)),
     "is_active_c8_DisplayModel");
  chartInstance->c8_is_c8_DisplayModel = c8_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c8_u, 11)), "is_c8_DisplayModel");
  chartInstance->c8_is_Screen = c8_f_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  c8_update_debugger_state_c8_DisplayModel(chartInstance);
...
static void sf_c8_DisplayModel(SFc8_DisplayModelInstanceStruct *chartInstance)
{
  ...
  c8_set_sim_state_side_effects_c8_DisplayModel(chartInstance);
  ...
  if (chartInstance->c8_is_active_c8_DisplayModel == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 2U, chartInstance->c8_sfEvent);
    chartInstance->c8_is_active_c8_DisplayModel = 1U;
    ...
    chartInstance->c8_prev_signal = FALSE;
    c8_updateDataWrittenToVector(chartInstance, 0U);
    _SFD_SYMBOL_SCOPE_POP();
    chartInstance->c8_is_c8_DisplayModel = c8_IN_Screen;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c8_sfEvent);
    chartInstance->c8_tp_Screen = 1U;
  ...
  *chartInstance)
{
  ...
  boolean_T *c8_valid_signal;
  boolean_T (*c8_signals)[3];
  c8_valid_signal = (boolean_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c8_signals = (boolean_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  ...
  if (c8_out) {
    ...
    if (c8_d_out) {
      ...
      c8_x = (real_T)(*c8_signals)[_SFD_ARRAY_BOUNDS_CHECK(0U, (int32_T)(real_T)
        _SFD_EML_ARRAY_BOUNDS_CHECK(
        "Transition #1666 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearLeftLock/Screen S"
        "ignals/Chart (MATLAB)\' (#1631): {diff=abs(signals(select(1))-signals(select(2)));}\n                                             "
        "                                                                                                                             ^^^"
        "^^^^", (int32_T)_SFD_INTEGER_CHECK(
        "Transition #1666 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearLeftLock/Screen S"
        "ignals/Chart (MATLAB)\' (#1631): {diff=abs(signals(select(1))-signals(select(2)));}\n                                             "
        "                                                                                                                                "
        "     ^^^^^^^^^", chartInstance->c8_select[0]), 1, 3, 1, 0) - 1, 1, 3, 1,
        0)] - (real_T)(*c8_signals)[_SFD_ARRAY_BOUNDS_CHECK(0U, (int32_T)(real_T)
        _SFD_EML_ARRAY_BOUNDS_CHECK(
        "Transition #1666 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearLeftLock/Screen S"
        "ignals/Chart (MATLAB)\' (#1631): {diff=abs(signals(select(1))-signals(select(2)));}\n                                             "
        "                                                                                                                                "
      ...
      if (c8_f_out) {
        ...
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_j_nargout, 1U,
          c8_sf_marshallOut, c8_sf_marshallIn);
        c8_errorIfDataNotWrittenToFcn(chartInstance, 6U, 9U);
        c8_A = (real_T)(*c8_signals)[_SFD_ARRAY_BOUNDS_CHECK(0U, (int32_T)
          (real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
          "Transition #1669 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearLeftLock/Screen S"
          "ignals/Chart (MATLAB)\' (#1631): {mean=(signals(select(1))+signals(select(2)))/2;}\n                                              "
          "                                                                                                                         ^^^^^^^",
          (int32_T)_SFD_INTEGER_CHECK(
          "Transition #1669 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearLeftLock/Screen S"
          "ignals/Chart (MATLAB)\' (#1631): {mean=(signals(select(1))+signals(select(2)))/2;}\n                                              "
          "                                                                                                                                "
          " ^^^^^^^^^", chartInstance->c8_select[0]), 1, 3, 1, 0) - 1, 1, 3, 1,
          0)] + (real_T)(*c8_signals)[_SFD_ARRAY_BOUNDS_CHECK(0U, (int32_T)
          (real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
          "Transition #1669 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearLeftLock/Screen S"
          "ignals/Chart (MATLAB)\' (#1631): {mean=(signals(select(1))+signals(select(2)))/2;}\n                                              "
          "                                                                                                                                "
          ...
          "ignals/Chart (MATLAB)\' (#1631): {mean=(signals(select(1))+signals(select(2)))/2;}\n                                              "
          "                                                                                                                                "
          "                    ^^^^^^^^^", chartInstance->c8_select[1]), 1, 3, 1,
          0) - 1, 1, 3, 1, 0)];
        c8_c_x = c8_A;
        c8_d_x = c8_c_x;
        ...
        *c8_valid_signal = (chartInstance->c8_mean != 0.0);
      ...
      if (c8_g_out) {
        ...
        *c8_valid_signal = (*c8_signals)[_SFD_ARRAY_BOUNDS_CHECK(0U, (int32_T)
          (real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
          "Transition #1657 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearLeftLock/Screen S"
          "ignals/Chart (MATLAB)\' (#1631): {valid_signal=signals(select(1));}\n                                                             "
          "                                                                                                                 ^^^^^^^",
          (int32_T)_SFD_INTEGER_CHECK(
          "Transition #1657 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearLeftLock/Screen S"
          "ignals/Chart (MATLAB)\' (#1631): {valid_signal=signals(select(1));}\n                                                             "
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 1U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  chartInstance->c8_sum_sig = ((real_T)(*c8_signals)[0] + (real_T)(*c8_signals)
    [1]) + (real_T)(*c8_signals)[2];
  ...
  for (c8_ix = 2; c8_ix < 4; c8_ix++) {
    c8_b_ix = c8_ix;
    c8_a = (*c8_signals)[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
  ...
  for (c8_c_ix = 2; c8_c_ix < 4; c8_c_ix++) {
    c8_d_ix = c8_c_ix;
    c8_b_a = (*c8_signals)[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", (real_T)c8_d_ix), 1, 3, 1, 0) - 1];
    c8_b_b = c8_c_mtmp;
    c8_b_p = ((int32_T)c8_b_a < (int32_T)c8_b_b);
    if (c8_b_p) {
  ...
  c8_d_mtmp = c8_c_mtmp;
  c8_minval = c8_d_mtmp;
  chartInstance->c8_middle = c8_hoistedGlobal - ((real_T)c8_maxval + (real_T)
    c8_minval);
  ...
  if (c8_out) {
    ...
    *c8_valid_signal = (chartInstance->c8_middle != 0.0);
    c8_updateDataWrittenToVector(chartInstance, 3U);
    _SFD_SYMBOL_SCOPE_POP();
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_DisplayModelInstanceStruct *chartInstance;
  chartInstance = (SFc8_DisplayModelInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c8_DisplayModel_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance, const mxArray *c8_b_tp_Screen, const char_T *c8_identifier)
{
  ...
  c8_thisId.fIdentifier = c8_identifier;
  c8_thisId.fParent = NULL;
  c8_y = c8_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c8_b_tp_Screen),
    &c8_thisId);
  ...
  *c8_inData)
{
  ...
  for (c8_i3 = 0; c8_i3 < 3; c8_i3++) {
    c8_b_inData[c8_i3] = (*(boolean_T (*)[3])c8_inData)[c8_i3];
  }

  for (c8_i4 = 0; c8_i4 < 3; c8_i4++) {
    c8_u[c8_i4] = c8_b_inData[c8_i4];
  }

  c8_y = NULL;
  sf_mex_assign(&c8_y, sf_mex_create("y", c8_u, 11, 0U, 1U, 0U, 1, 3), FALSE);
  sf_mex_assign(&c8_mxArrayOutData, c8_y, FALSE);
  return c8_mxArrayOutData;
}
  ...
  *c8_inData)
{
  ...
  for (c8_i7 = 0; c8_i7 < 2; c8_i7++) {
    c8_b_inData[c8_i7] = (*(real_T (*)[2])c8_inData)[c8_i7];
  }
  ...
  const mxArray *c8_b_select, const char_T *c8_identifier, real_T c8_y[2])
{
  ...
  c8_thisId.fIdentifier = c8_identifier;
  c8_thisId.fParent = NULL;
  c8_i_emlrt_marshallIn(chartInstance, sf_mex_dup(c8_b_select), &c8_thisId, c8_y);
  ...
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData)
{
  ...
  for (c8_i10 = 0; c8_i10 < 2; c8_i10++) {
    (*(real_T (*)[2])c8_outData)[c8_i10] = c8_y[c8_i10];
  }
...
void sf_c8_DisplayModel_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_DisplayModel_get_autoinheritance_info(void)
{
...
mxArray *sf_c8_DisplayModel_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_DisplayModel_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c8_DisplayModel(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x3'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c8_DisplayModel\",},{M[9],M[0],T\"is_c8_DisplayModel\",},{M[9],M[19],T\"is_Screen\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 13, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_DisplayModel_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc8_DisplayModelInstanceStruct *chartInstance;
    chartInstance = (SFc8_DisplayModelInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          boolean_T (*c8_signals)[3];
          real_T (*c8_validity)[3];
          c8_valid_signal = (boolean_T *)ssGetOutputPortSignal(chartInstance->S,
            1);
          c8_validity = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
          c8_signals = (boolean_T (*)[3])ssGetInputPortSignal(chartInstance->S,
            0);
...
static void sf_opaque_initialize_c8_DisplayModel(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_DisplayModelInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_DisplayModel((SFc8_DisplayModelInstanceStruct*)
    chartInstanceVar);
  initialize_c8_DisplayModel((SFc8_DisplayModelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_DisplayModel(void *chartInstanceVar)
{
  enable_c8_DisplayModel((SFc8_DisplayModelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_DisplayModel(void *chartInstanceVar)
{
  disable_c8_DisplayModel((SFc8_DisplayModelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_DisplayModel(void *chartInstanceVar)
{
  sf_c8_DisplayModel((SFc8_DisplayModelInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_DisplayModel(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_DisplayModel
    ((SFc8_DisplayModelInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_DisplayModel();/* state var info */
...
extern void sf_internal_set_sim_state_c8_DisplayModel(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c8_DisplayModel((SFc8_DisplayModelInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_DisplayModel(SimStruct* S)
{
  return sf_internal_get_sim_state_c8_DisplayModel(S);
}

static void sf_opaque_set_sim_state_c8_DisplayModel(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c8_DisplayModel(S, st);
}

static void sf_opaque_terminate_c8_DisplayModel(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_DisplayModelInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_DisplayModel_optimization_info();
    }

    finalize_c8_DisplayModel((SFc8_DisplayModelInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_DisplayModel((SFc8_DisplayModelInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_DisplayModel(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_DisplayModel(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c8_DisplayModel(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_DisplayModel(SimStruct *S)
{
  SFc8_DisplayModelInstanceStruct *chartInstance;
  chartInstance = (SFc8_DisplayModelInstanceStruct *)utMalloc(sizeof
    (SFc8_DisplayModelInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_DisplayModelInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c8_DisplayModel;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_DisplayModel;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c8_DisplayModel;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_DisplayModel;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c8_DisplayModel;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c8_DisplayModel;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c8_DisplayModel;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_DisplayModel;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_DisplayModel;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_DisplayModel;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c8_DisplayModel;
...
void c8_DisplayModel_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_DisplayModel(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_DisplayModel(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_DisplayModel(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_DisplayModel_method_dispatcher.\n"
