  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"LandingGearModeLib")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3784142908U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(929398581U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(726518230U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3200040388U);
        } else if (nrhs==4) {
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(aiChksum, "eDci7jCKTJ9BWQcpG9dVGB") == 0) {
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(tpChksum, "6pER6kMsK3Z18p3Bgt0MWD") == 0) {
...
mxArray* load_LandingGearModeLib_optimization_info(void)
{
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "LandingGearModeLib", "DisplayModel");
