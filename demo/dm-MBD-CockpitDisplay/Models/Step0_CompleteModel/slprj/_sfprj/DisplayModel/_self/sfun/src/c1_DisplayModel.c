  ...
  if (c1_out) {
    ...
    if (c1_d_out) {
      ...
      c1_x = (real_T)(*c1_signals)[_SFD_ARRAY_BOUNDS_CHECK(0U, (int32_T)(real_T)
        ...
        "Transition #59 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearRightLock/Screen Si"
        "gnals/Chart (MATLAB)\' (#24): {diff=abs(signals(select(1))-signals(select(2)));}\n                                                "
        "                                                                                                                       ^^^^^^^",
        ...
        - (real_T)(*c1_signals)[_SFD_ARRAY_BOUNDS_CHECK(0U, (int32_T)(real_T)
        _SFD_EML_ARRAY_BOUNDS_CHECK(
        "Transition #59 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearRightLock/Screen Si"
        "gnals/Chart (MATLAB)\' (#24): {diff=abs(signals(select(1))-signals(select(2)));}\n                                                "
        "                                                                                                                                "
        ...
        "gnals/Chart (MATLAB)\' (#24): {diff=abs(signals(select(1))-signals(select(2)));}\n                                                "
        "                                                                                                                                "
        "                  ^^^^^^^^^", chartInstance->c1_select[1]), 1, 3, 1, 0)
        - 1, 1, 3, 1, 0)];
      c1_b_x = c1_x;
      ...
      if (c1_f_out) {
        ...
        c1_A = (real_T)(*c1_signals)[_SFD_ARRAY_BOUNDS_CHECK(0U, (int32_T)
          ...
          "Transition #62 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearRightLock/Screen Si"
          "gnals/Chart (MATLAB)\' (#24): {mean=(signals(select(1))+signals(select(2)))/2;}\n                                                 "
          "                                                                                                                   ^^^^^^^",
          (int32_T)_SFD_INTEGER_CHECK(
          "Transition #62 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearRightLock/Screen Si"
          "gnals/Chart (MATLAB)\' (#24): {mean=(signals(select(1))+signals(select(2)))/2;}\n                                                 "
      ...
      if (c1_g_out) {
        ...
        *c1_valid_signal = (*c1_signals)[_SFD_ARRAY_BOUNDS_CHECK(0U, (int32_T)
          (real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
          "Transition #50 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearRightLock/Screen Si"
          "gnals/Chart (MATLAB)\' (#24): {valid_signal=signals(select(1));}\n                                                                "
          "                                                                                                           ^^^^^^^",
          (int32_T)_SFD_INTEGER_CHECK(
          "Transition #50 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearRightLock/Screen Si"
          "gnals/Chart (MATLAB)\' (#24): {valid_signal=signals(select(1));}\n                                                                "
