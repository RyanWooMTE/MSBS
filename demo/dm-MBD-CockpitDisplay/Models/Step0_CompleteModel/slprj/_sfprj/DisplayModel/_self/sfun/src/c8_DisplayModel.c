  ...
  if (c8_out) {
    ...
    if (c8_d_out) {
      ...
      c8_x = (real_T)(*c8_signals)[_SFD_ARRAY_BOUNDS_CHECK(0U, (int32_T)(real_T)
        ...
        "Transition #174 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearLeftLock/Screen Si"
        "gnals/Chart (MATLAB)\' (#139): {diff=abs(signals(select(1))-signals(select(2)));}\n                                               "
        "                                                                                                                         ^^^^^^^",
        ...
        - (real_T)(*c8_signals)[_SFD_ARRAY_BOUNDS_CHECK(0U, (int32_T)(real_T)
        _SFD_EML_ARRAY_BOUNDS_CHECK(
        "Transition #174 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearLeftLock/Screen Si"
        "gnals/Chart (MATLAB)\' (#139): {diff=abs(signals(select(1))-signals(select(2)));}\n                                               "
        "                                                                                                                                "
      ...
      if (c8_f_out) {
        ...
        c8_A = (real_T)(*c8_signals)[_SFD_ARRAY_BOUNDS_CHECK(0U, (int32_T)
          ...
          "Transition #177 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearLeftLock/Screen Si"
          "gnals/Chart (MATLAB)\' (#139): {mean=(signals(select(1))+signals(select(2)))/2;}\n                                                "
          "                                                                                                                     ^^^^^^^",
          (int32_T)_SFD_INTEGER_CHECK(
          "Transition #177 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearLeftLock/Screen Si"
          "gnals/Chart (MATLAB)\' (#139): {mean=(signals(select(1))+signals(select(2)))/2;}\n                                                "
          ...
          "gnals/Chart (MATLAB)\' (#139): {mean=(signals(select(1))+signals(select(2)))/2;}\n                                                "
          "                                                                                                                                "
          "                ^^^^^^^^^", chartInstance->c8_select[1]), 1, 3, 1, 0)
          - 1, 1, 3, 1, 0)];
        c8_c_x = c8_A;
        c8_d_x = c8_c_x;
      ...
      if (c8_g_out) {
        ...
        *c8_valid_signal = (*c8_signals)[_SFD_ARRAY_BOUNDS_CHECK(0U, (int32_T)
          (real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
          "Transition #165 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearLeftLock/Screen Si"
          "gnals/Chart (MATLAB)\' (#139): {valid_signal=signals(select(1));}\n                                                               "
          "                                                                                                             ^^^^^^^",
          (int32_T)_SFD_INTEGER_CHECK(
          "Transition #165 in Chart \'Control_and_Display_Logic/SignalConditioning/SignalSelection/DataValidityLandingGearLeftLock/Screen Si"
          "gnals/Chart (MATLAB)\' (#139): {valid_signal=signals(select(1));}\n                                                               "
