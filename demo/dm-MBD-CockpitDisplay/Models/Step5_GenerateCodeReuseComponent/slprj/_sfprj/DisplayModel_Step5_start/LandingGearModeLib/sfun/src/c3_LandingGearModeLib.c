  ...
  *chartInstance)
{
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  if (chartInstance->c3_temporalCounter_i1 < 63U) {
  ...
  if (chartInstance->c3_is_active_c3_LandingGearModeLib == 0U) {
  ...
  *chartInstance)
{
  ...
  if (c3_out) {
    ...
    *c3_LandingGearMode = 3.0;
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_c_out, 2U, c3_b_sf_marshallOut,
      c3_b_sf_marshallIn);
    c3_c_out = CV_EML_IF(18, 0, 0, chartInstance->c3_temporalCounter_i1 >= 50);
    _SFD_SYMBOL_SCOPE_POP();
    if (c3_c_out) {
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(288453185U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3458995397U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1533024793U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2378562533U);
}
...
mxArray *sf_c3_LandingGearModeLib_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("9bhvRl0WSwI3rreAPlLqp");
...
{
  return sf_internal_get_sim_state_c3_LandingGearModeLib(S);
}

static void sf_opaque_set_sim_state_c3_LandingGearModeLib(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_LandingGearModeLib(S, st);
}
...
static void mdlSetWorkWidths_c3_LandingGearModeLib(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3158768006U));
  ssSetChecksum1(S,(2275633582U));
  ssSetChecksum2(S,(228303918U));
  ssSetChecksum3(S,(763565986U));
