#include "DisplayModel_Step5_start_sfun.h"
#include "sfcdebug.h"
...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_DisplayModel_Step5_start_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_LandingGearModeLib_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_DisplayModel_Step5_start_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
{
  extern unsigned int sf_DisplayModel_Step5_start_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "DisplayModel_Step5_start") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_DisplayModel_Step5_start_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_DisplayModel_Step5_start_third_party_uses_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "DisplayModel_Step5_start") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_DisplayModel_Step5_start_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_DisplayModel_Step5_start_updateBuildInfo_args_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "DisplayModel_Step5_start") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_DisplayModel_Step5_start_updateBuildInfo_args_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_DisplayModel_Step5_start_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "DisplayModel_Step5_start") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_DisplayModel_Step5_start_get_eml_resolved_functions_info(nlhs,plhs,
      2,newRhs);
  }
...
extern unsigned int sf_DisplayModel_Step5_start_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"DisplayModel_Step5_start")) {
    return(sf_DisplayModel_Step5_start_method_dispatcher(simstructPtr,
...
extern void DisplayModel_Step5_start_terminator(void);
...
void sf_machine_global_terminator(void)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    DisplayModel_Step5_start_terminator();
...
extern void DisplayModel_Step5_start_initializer(void);
extern void LandingGearModeLib_initializer(void);
extern void DisplayModel_Step5_start_register_exported_symbols(SimStruct* S);
extern void LandingGearModeLib_register_exported_symbols(SimStruct* S);
extern void DisplayModel_Step5_start_debug_initialize(struct
...
{
  DisplayModel_Step5_start_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      DisplayModel_Step5_start_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    DisplayModel_Step5_start_initializer();
    if (!simModeIsRTWGen) {
